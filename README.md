...
git clone https://github.com/prahaladbelavadi/electron-App.git
...
- [```TypeError: Cannot read property 'on' of undefined #107```](https://github.com/electron/electron-quick-start/issues/107)
